				...
				<tr>
					<td class="info">
						...
						<table align="center">
							<tr class="celda2">
								<td
									colspan="<%=(session.getAttribute("estructura") != null)
						? "2"
						: "1"%>"
									align="center">
									<h2 class="curso">
							...
							<tr>
								<td>
									<icesi:esquema padre="parciales" estructura="estructura"
										estudiante="true" />
								</td>
								<%
									if (session.getAttribute("estructura") != null
												&& request.getAttribute("modificarEstructuraForm") != null) {
								%>
								<td>
									<div class="curso" align="center">
										<bean:message key="titulo.esquema.estudiante" />
										<bean:write name="modificarEstructuraForm" scope="request"
											property="nombre" />
									</div>
	    						...
	    						--%>
										...
										<tr>
											...
											<td class="etiqueta">
												<bean:write property="porcentaje"
													name="modificarEstructuraForm" scope="request" />
												%
											</td>
										</tr>
										<tr>
											...
											<td class="etiqueta">
												<bean:write property="fechaRealizacion"
													name="modificarEstructuraForm" scope="request" />
											</td>
										</tr>
										<tr>
											...
											<td class="etiqueta">
												<bean:write property="descripcion"
													name="modificarEstructuraForm" scope="request" />
											</td>
										</tr>
										<tr>
											...
											<td class="etiqueta">
												<bean:write property="temas" name="modificarEstructuraForm"
													scope="request" />
											</td>
										</tr>
									</table>
