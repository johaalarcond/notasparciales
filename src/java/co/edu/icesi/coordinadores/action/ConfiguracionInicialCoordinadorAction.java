 ...
 */
public class ConfiguracionInicialCoordinadorAction extends Action {
        ...
        //try {
          //  HttpSession sesion = ControlSesion.obtenerSesion(request);
            ...
            if(opcion.equals("1")){
                ...
                return mapping.findForward("continuacion");
                
            }
            
            if (opcion.equals("2")){
            // clonar pero para todos los grupos!
            }
    ...
    public int obtenerCursoAnterior(ControlProfesores profesores,
        ...
        try {
            ...
            String sql = "select count(*) cantidad "
                    + "from tntp_cursos cur,tntp_clasif_categ cla, tntp_categorias cat, tntp_actividades act "
