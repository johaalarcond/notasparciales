 ...
 */
public class ModificarEsquemaAction extends Action {
            ...
            if (sesion != null) {
                ...
                if (opcion.equals("0")) {
                    ...
                    if (lista.size() > 1) { 
                        ...
                        //ffceballos  
                        //se obtiene la actividad a eliminar para buscar su porcentaje y distribuirlo entre las demas actividades con la misma categoría
                        Activity actividadEliminar=(Activity)lista.get(Integer.parseInt(indice));  
                        //fin ffceballos
                        
                        
                        //ffceballos esta parte es para ver si al eliminar la actividad no se elimina la categoría
                       
                        int cantidad=0;
                        String categoria=actividadEliminar.getCategory();
                        for(int cont=0; cont<lista.size();cont++){
                           
                             Activity temporal=(Activity)lista.get(cont);
                             if(temporal.getCategory().equals(categoria)){
                                   cantidad++;                               
                             }
                        }          
                       ...
                       if(curso.getDepartamento().equals("08")){
                           
                        // System.out.println("Es matematicas");
                         
                         boolean a = ((Boolean)sesion.getAttribute("RCOORDINMAT")).booleanValue();
                         boolean b = ((Boolean)sesion.getAttribute("RSECREMAT")).booleanValue();
                                                  
                         if(!a&&!b){                
                        
                        if(actividadEliminar.getName()!=null && actividadEliminar.getName()!=""){    
                            // esta última validación es para cuando por error le de agregar actividad la pueda borrar
                        errores.add("categoriaCero", new ActionError("errores.categoriaCero"));
                        ...
                        if(cantidad>1){
                        //System.out.println("Cantidad mayor que 2?!!");
                        //ffceballos
                        double porcentajeCateg=actividadEliminar.getPercentage();
                        //categoria=actividadEliminar.getCategory();
                       // double porcentajeDistribuir=actividadEliminar.getPercentage();                                
                        ...
                        ArrayList actividades=new ArrayList();
                          for(int cont=0; cont<lista.size();cont++){
                              ...
                              if(temporal.getCategory().equals(categoria)){
                                  ...
                                  porcentajeCateg+=temporal.getPercentage();
                        ...
                        int totalCateg=actividades.size();
                        ...
                        Iterator itera=actividades.iterator();
                        while(itera.hasNext()){
			((Activity)itera.next()).setPercentage(porcentajeAct);
                        }
			...
			while(diferencia!=0){
				...
				while(iterador.hasNext() && continuar){
					...
					if(diferencia>0){
                        ...
                        //System.out.println("*********modificar esuqema!!*********");
                ...
                if (opcion.equals("1")) { 
                    ...
                    //ffceballos  validar que si el coordinador no ha creado la categoría a la cuál desea agregar, le salga mensaje de error
